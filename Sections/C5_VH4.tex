...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item \zlf: constrained mostly in 1 $LN$-tagged $V+l$ CR. Applied in CRHigh. % TODO, in the text, it says that it's SR - CRHigh, but it's constrained in LN??
    \end{itemize}
\end{itemize}
...
\subsubsection{$W+$jets} % TODO boosted
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item \wlf: constrained mostly in 1 $LN$-tagged $V+l$ CR. Applied in CRHigh. % TODO, in the text, it says that it's SR - CRHigh, but it's constrained in LN??
    \end{itemize}
...
\subsection{Top Modelling}\label{sec-modTop} % TODO boosted?
...
For the background components\footnote{Thus excluding the signal-like $VZbb$ and $VZcc$.} $qqWW$, $W_{\text{had}}Z_{\text{lep}}$, $W_{\text{lep}}Z_{\text{had}}$, and $ZZ$ where the had or lep index specifies the type of decay, the acceptances uncertainties included are:
\begin{itemize}[leftmargin=*]
